...
internal fun MutableState<com.airbnb.android.showkase.models.ShowkaseBrowserScreenMetadata>.clear() {
    update {
        copy(
...
internal fun MutableState<com.airbnb.android.showkase.models.ShowkaseBrowserScreenMetadata>.clearActiveSearch() {
    update {
        copy(
            isSearchActive = false,
            searchQuery = null
